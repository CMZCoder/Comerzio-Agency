...
const projects = [
    {
        id: 'commerzio',
        title: 'Commerzio - Services',
        descriptionKey: 'commerzio_desc',
        url: 'https://services.commerzio.online',
        images: ['/assets/Commerzio_home.png', '/assets/Commerzio_home_2.png', '/assets/Commerzio_preview2.png'],
        ...
        <div className="project-card-wrapper">
            ...
            >
                <div className="project-image-container">
                    {project.id === 'commerzio' && (
                        <div className="ribbon-wrapper">
                            <div className="ribbon">{t('in_development')}</div>
                        </div>
                    )}
